    ...
    def __init__(self, env, *args, **kwargs):
        ...
        self.recent_frames = np.zeros(
            (env.frame_stacks, 144, 
             160, 3),
            dtype=np.uint8)
        self.memory = FixedFIFO(1)
        self.last_act = FixedFIFO(1)
                      ...
                      messages=[
                        {
                          ...
                          "content": [
                                        {
            "type": "text",
            "text": "Summerize the current game state based on the last game state and the last message or action generated by yourself. Focus on: have you made any progress on the game? are you in the loop? what is your short term goal and what is your long term goal? what action you should take in order to complete your goal? Here is your last game state:" + str(self.memory.get_item()) + ". And here is the last message you produced:" + str(msg),
          },
                ],
              }
            ],
    ...
    def step(self):
        ...
        while act not in ("A", "B", "UP", "DOWN", "LEFT", "RIGHT"):   
                  ...
                  "content": [
          {
            ...
            "text": "Your current state of the game is: " + str(self.memory.get_item(0)) + "." + "Your last action is: " + str(self.last_act.get_item(0)) + '.' + 
